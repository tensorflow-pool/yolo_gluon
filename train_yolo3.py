...
def parse_args():
    ...
    parser.add_argument('--network', type=str, default='darknet53',
                        help="Base network name which serves as feature extraction base. mobilenet1.0")
...
if __name__ == '__main__':
    ...
    if args.syncbn and len(ctx) > 1:
        ...
        net = get_model(net_name, pretrained_base=True, pretrained=False)
        async_net = net
    if args.resume.strip():
        ...
        with warnings.catch_warnings(record=True) as w:
            ...
            # net.initialize(mx.init.Xavier(rnd_type="gaussian", magnitude=3))
            # async_net.initialize(mx.init.Xavier(rnd_type="gaussian", magnitude=1))
